...
static CGFloat      const   _bottomOffset = 20;
static CGFloat      const   _cardScale = 0.9f;
...
static NSInteger    const   _aheadCardCount = 3;
...
#define CardWeakSelf __weak typeof(self) weakSelf = self
